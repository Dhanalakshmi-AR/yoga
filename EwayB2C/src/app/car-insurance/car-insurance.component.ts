...
export class CarInsuranceComponent implements OnInit {
  ...
  mainBodyTypeList: ConcatArray<{ label: string; value: string; Code: string; CodeDesc: string; }>;
  ...
  checkModelDropdownHide(){
    if(this.vehicleForm.controls['bodyType'].value=='1' || this.vehicleForm.controls['bodyType'].value=='2' || this.vehicleForm.controls['bodyType'].value=='3' || this.vehicleForm.controls['bodyType'].value=='' || this.vehicleForm.controls['bodyType'].value==null){  return false; }
    else{console.log(this.vehicleForm.controls['bodyType'].value); return true; }
  }
  checkModelFieldHide(){
    if((this.vehicleForm.controls['bodyType'].value!='1' && this.vehicleForm.controls['bodyType'].value!='2' && this.vehicleForm.controls['bodyType'].value!='3' && this.vehicleForm.controls['bodyType'].value!='' && this.vehicleForm.controls['bodyType'].value!=null) || this.vehicleForm.controls['model'].value=='99999'){  return false; }
    else{ return true; }
  }
  ...
  goToCarInsurancePremium() {
    // Navigate to the car-insurance-premium component
